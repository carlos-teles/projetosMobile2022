...
export default function App() {
  const carrosJSON = [
    { id: 1, marca: "Saab", anoFabrica:2017, combustivel: "Gasolina", preco: 50000 },
    { id: 2, marca: "Volvo", anoFabrica:2019, combustivel: "Gasolina", preco: 200000 },
    { id: 3, marca: "BMW", anoFabrica: 2012, combustivel: "Diesel" , preco: 300000},
    { id: 4, marca: "Vw", anoFabrica: 2020, combustivel: "Gasolina", preco: 300000 },
    { id: 5, marca: "Toyota",anoFabrica:2022, combustivel: "GNV", preco: 256000 },
    { id: 6, marca: "Audi",anoFabrica:2022, combustivel: "GNV", preco: 1000000 },
    { id: 7, marca: "Audi TT",anoFabrica:2022, combustivel: "GNV", preco: 1000000 },    
  ];
...
//console.log( carrosJSON.reduce((total, carro) => total + carro.preco, 0)); 
  ...
  return (
    <View style={styles.container}>
      <Text>---
        {"\n"}
        {carrosJSON.map(({ marca, combustivel, preco }) => (
         `Marca do carro ${marca} combustível ${combustivel} preço R$ ${preco}\n`
        ))}
        {`Valor Total:R$`+carrosJSON.reduce((total, carro) => total + carro.preco, 0)}
        {"\n"}
      ---</Text>
